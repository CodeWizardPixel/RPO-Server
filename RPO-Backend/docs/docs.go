    ...
    "paths": {
                ...
                "responses": {
                    "200": {
                        ...
                        "schema": {
                            "type": "array",
                            "items": {
                                "$ref": "#/definitions/repository.Card"
                            }
                        }
                    },
                    "405": {
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/handlers.CardBalanceRequest"
                        }
                    }
                ],
                "responses": {
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/handlers.CardRequest"
                        }
                    }
                ],
                "responses": {
                ...
                "responses": {
                    "200": {
                        ...
                        "schema": {
                            "type": "array",
                            "items": {
                                "$ref": "#/definitions/repository.Key"
                            }
                        }
                    },
                    "405": {
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/handlers.KeyRequest"
                        }
                    }
                ],
                "responses": {
                ...
                "responses": {
                    "200": {
                        ...
                        "schema": {
                            "type": "array",
                            "items": {
                                "$ref": "#/definitions/repository.Terminal"
                            }
                        }
                    },
                    "405": {
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/handlers.TerminalRequest"
                        }
                    }
                ],
                "responses": {
        ...
        "/transactions/authorize": {
            "post": {
                ...
                "parameters": [
                    {
                        "description": "card_number, terminal_serial_number, amount, operation (withdraw or deposit)",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
